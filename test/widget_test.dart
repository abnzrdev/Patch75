      ...
      tester
          ...
          .any(
            (widget) => widget.text.toPlainText().contains(
              'Return the increasing pair of indices whose values add to the requested total, or an empty list.',
            ),
          ),
      isTrue,
    );
...
const _twoSumJson = r'''
{
  ...
  "description": "Return the increasing pair of indices whose values add to the requested total, or an empty list.",
  "examples": [{"input":"nums = [8,6], target = 14","output":"[0,1]"}],
