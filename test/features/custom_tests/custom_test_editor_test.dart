...
{"id":1,"slug":"two-sum","title":"Two Sum","difficulty":"easy","topics":["array"],"description":"Return the increasing pair of matching indices.","examples":[],"constraints":[],"starterCodeByLanguage":{"python":"class Solution: pass"},"testCases":[{"id":"sample-1","input":{"nums":[8,6],"target":14},"expected":[0,1],"sample":true}],"source":"Patch75","sourceUrl":"","license":"AGPL-3.0-only","originalContent":true}
''';
